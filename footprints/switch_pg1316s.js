...
//To Be Implemented    pad_vias: default is false
//        If true, vias will be created in the center of each data pad (i.e. P1 and P2).
//TBI    pad_via_size: default is 0.8
//        Size in mm of via holes in P1 and P2. No effect if pad_vias = false. Please
//        be aware that these vias can leak solder (and at the default size almost
//        certainly will) which can require cleanup and/or damage equipment!
//TBI    mp_vias: default is false
//        If true, vias will be created in the center of each mounting pad (all P3).
//TBI    mp_via_size: default is 0.6
