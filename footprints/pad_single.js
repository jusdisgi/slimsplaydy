...
fp.push(`(footprint "Pad_Single_BAT-"`);
fp.push(p.at);
...
// Pads
fp.push(`(pad "1" smd roundrect (at ${(flip ? -0.75 : 0.75)} 0.5 ${p.r}) (size 1.3 0.8) (layers "${(flip ? "B" : "F")}.Cu" "${(flip ? "B" : "F")}.Mask" "${(flip ? "B" : "F")}.Paste") (roundrect_rratio 0.15) (thermal_bridge_angle 45)  ${p.P1})`);

// Drawings on F.SilkS
fp.push(`(fp_rect (start ${(flip ? -0 : 0)} 0) (end ${(flip ? -1.5 : 1.5)} 1) (stroke (width 0.1) (type default)) (fill no) (layer "${(flip ? "B.SilkS" : "F.SilkS")}") )`);

// Zones
fp.push(`(zone (net 0) (net_name "") (layer "${(flip ? "B.SilkS" : "F.SilkS")}")  (hatch edge 0.5) (connect_pads (clearance 0)) (min_thickness 0.25) (filled_areas_thickness no) (keepout (tracks allowed) (vias allowed) (pads not_allowed) (copperpour allowed) (footprints not_allowed)) (placement (enabled no) (sheetname "")) (fill (thermal_gap 0.5) (thermal_bridge_width 0.5)) (polygon (pts ${zoneXY(p, flip ? -0 : 0, 0)} ${zoneXY(p, flip ? -1.5 : 1.5, 0)} ${zoneXY(p, flip ? -1.5 : 1.5, 1)} ${zoneXY(p, flip ? -0 : 0, 1)})))`);

// Properties
// fp.push(`(property "Reference" "BAT-" (at 0 -0.5 ${(p.r + 0) % 360}) (unlocked yes) (layer "${(flip ? "B.SilkS" : "F.SilkS")}")  (effects (font (size 0.5 0.5) (thickness 0.1)) (justify${ flip ? " mirror" : ""})))`);
// fp.push(`(property "Value" "Pad_Single_BAT-" (at 0 1 ${(p.r + 0) % 360}) (unlocked yes) (layer "${(flip ? "B.Fab" : "F.Fab")}") (hide yes)  (effects (font (size 1 1) (thickness 0.15)) (justify${ flip ? " mirror" : ""})))`);
